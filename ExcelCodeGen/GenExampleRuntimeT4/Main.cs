...
//------------------------------------------------------------------------------
namespace ");
            this.Write(this.ToStringHelper.ToStringWithCulture(RectangleModel.Namespace));
            this.Write("\r\n{\r\n    using System;   \r\n    \r\n    public sealed class ");
            ...
            this.Write(" of the object.\r\n        private ");
            this.Write(this.ToStringHelper.ToStringWithCulture(types[i]));
            this.Write(" ");
            this.Write(this.ToStringHelper.ToStringWithCulture(field));
            this.Write("Value;\r\n\r\n        // The ");
            this.Write(this.ToStringHelper.ToStringWithCulture(props[i]));
            this.Write(" property for the object.\r\n        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture(types[i]));
            this.Write(" ");
            this.Write(this.ToStringHelper.ToStringWithCulture(props[i]));
...
foreach (var property in props)
            {
            this.Write("result += string.Format(\"\\r\\n ");
            ...
            this.Write("return result;\r\n        }\r\n        \r\n        public static void Main()\r\n        {" +
                    "\r\n            var testRectangle = new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(RectangleModel.Class));
            this.Write("(");
            this.Write(this.ToStringHelper.ToStringWithCulture(RectangleModel.InitialValues));
